...
table(dat$DB_BPT, dat$gpcprep)
dat %>% select(DB_BPT, gpcprep) %>% table(useNA = "ifany")
...
table(dat$PEF_init_1hour_all, useNA = "ifany")
table(dat$PEF_init_1hour_all, dat$PEF_init_recorded, useNA = "ifany")

table(dat$BM_PEF_1hour)
summary(dat$RSR_24hour)

dat <- dat %>% mutate(BM_RSR_24hour = NA)
dat$BM_RSR_24hour[dat$RSR_BPT == "<24 hours"] <- 1
dat$BM_RSR_24hour[dat$RSR_BPT != "<24 hours"] <- 0 
summary(dat$BM_RSR_24hour)
table(dat$BM_RSR_24hour, useNA = "ifany")

table(dat$RSR_BPT, useNA = "ifany")
...
write.csv(quartz_fmt, file =
  "C:/Users/aadamson/Documents/Audit_2023_onwards/2022-2023/AA/Analysis/Output/AA_SCC_2022-2023_benchmarking_quartiles.csv",
          row.names = FALSE)
...
write.csv(bmk, file =
   "C:/Users/aadamson/Documents/Audit_2023_onwards/2022-2023/AA/Analysis/Output/AA_SCC_2022-2023_benchmarking.csv",
  row.names = FALSE)
